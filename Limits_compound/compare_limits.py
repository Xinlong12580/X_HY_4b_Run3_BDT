...
for MY in All_Limits[modes[0]]["YSlice"]:
    ...
    if MY in run2_Limits["YSlice"]:
        ...
        ax.plot(MXs, [obs/ np.sqrt(173/138) for obs in Obses], marker='X', color = "black", alpha = 0.5, label = "run2/sqrt(173/138)",  markersize = markersize)
...
for MX in All_Limits[modes[0]]["XSlice"]:
    ...
    if MX in run2_Limits["XSlice"]:
        ...
        ax.plot(MYs, [obs/ np.sqrt(173/138) for obs in Obses], marker='X', color = "black", alpha = 0.5, label = "run2/sqrt(173/138)",  markersize = markersize)
