...
if [ $limits = 1 ]; then 
    ...
    (set -x; combine -M FitDiagnostics -d $wsm -m 125 -n "r_$r" -v $verbosity $parameters --saveWorkspace --rMin "-15" --rMax 15 --saveToys --bypassFrequentistFit -s $seed  --floatParameters r   --justFit --toysFrequentist -t 20 )
