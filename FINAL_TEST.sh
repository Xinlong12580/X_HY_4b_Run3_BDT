...
python run_skim.py -d raw_nano/files/2023__SignalMC_XHY4b__MX-3000_MY-200.txt -y 2023 -n 1 -i 0
python run_selection_1p1_BDT.py -d skimmed_2023__SignalMC_XHY4b__MX-3000_MY-200.txt_n-1_i-0.root -y 2023 -n 1 -i 0 -s nom
ls -lh *root
