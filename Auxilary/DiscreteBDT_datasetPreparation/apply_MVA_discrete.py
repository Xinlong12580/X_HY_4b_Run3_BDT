...
if args.mode == "1p1":
    ...
    ROOT.gInterpreter.Declare('MVA_evaluator evaluator(4, std::vector<std::string>({ "Delta_Y", "MassHiggsCandidate_regressed", "Tagger_H_decapitated", "Tagger_Y_decapitated"}), "dataset_' + args.mode + "_" + args.year +'_discrete/weights/TMVAClassification_BDTG_' + args.mode + "_" + args.year + '.weights.xml", 0, {} );')
elif args.mode == "2p1":
