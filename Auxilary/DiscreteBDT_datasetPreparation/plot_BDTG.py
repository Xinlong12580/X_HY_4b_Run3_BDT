...
root_file = f"TMVAC_{args.mode}_{args.year}_discrete.root"
dataset = f"dataset_{args.mode}_{args.year}_discrete"
...
h_train_S.SetTitle(f"BDT Classifier Output ({args.mode} {args.year})")
