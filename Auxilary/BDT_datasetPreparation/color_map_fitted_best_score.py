...
# Load data from file
data = np.loadtxt(f"fitted_score_{args.mode}.txt")
...
# Save plot
plt.savefig(f"linear_fitted_BDT_score_{args.mode}.png", dpi=300)
plt.xscale("log")
plt.yscale("log")
plt.savefig(f"log_best_fitted_score_{args.mode}.png", dpi=300)
