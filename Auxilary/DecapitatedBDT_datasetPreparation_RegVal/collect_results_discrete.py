...
best_TTBarEffs = []
for _file in files:
    if f"MX{args.mx}_MY{args.my}" not in _file or "condor" in _file or "FAILED" in _file or args.mode not in _file or (args.year + "_") not in _file :
        continue
    print(_file)
