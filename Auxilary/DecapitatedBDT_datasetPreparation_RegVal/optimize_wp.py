...
parser.add_argument('--expr', type=str, dest='expr',action='store', default="100*(1.75e-6 * exp(0.0017 * x) + 4.48e-4) ")
#parser.add_argument('--expr', type=str, dest='expr',action='store', default="0.002")
#parser.add_argument('--expr', type=str, dest='expr',action='store', default="7e-6 * exp(0.0017 * x) + 1.792e-3 ")
#parser.add_argument('--expr', type=str, dest='expr',action='store', default="1.2957e-06 * exp(0.0018 * x) + 9.4844e-04 ")
...
sig_rdf = sig_rdf.Filter("event_Idx%2 == 1")
