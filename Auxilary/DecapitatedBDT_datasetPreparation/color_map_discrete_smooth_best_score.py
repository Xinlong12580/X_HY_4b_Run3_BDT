...
# Load data from file
data = np.loadtxt(f"best_scores_discrete_{args.mode}_smooth.txt")
...
# Save plot
plt.savefig(f"linear_best_BDT_score_smooth_discrete_{args.mode}.png", dpi=300)
plt.xscale("log")
plt.yscale("log")
plt.savefig(f"log_best_BDT_score_smooth_discrete_{args.mode}.png", dpi=300)
