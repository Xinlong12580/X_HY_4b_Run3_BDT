...
'''
h_com = rdf.Histo1D((f"gen_MX{massX}_MY{massY}_delta_eta", f"gen_MX{massX}_MY{massY}_deta_eta", 101, 0, 5), f"DeltaEta").GetValue()
c = ROOT.TCanvas("c", "c")
h_com.Draw()
c.Print(f"gen_MX{massX}_MY{massY}_DeltaEta.png")

h_com = rdf.Histo1D((f"gen_MX{massX}_MY{massY}_delta_Y", f"gen_MX{massX}_MY{massY}_deta_Y", 101, 0, 5), f"DeltaY").GetValue()
c = ROOT.TCanvas("c", "c")
h_com.Draw()
c.Print(f"gen_MX{massX}_MY{massY}_DeltaY.png")
